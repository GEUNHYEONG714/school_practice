...
# 필요하면 받아온 자료형을 확인해 볼 수 있다. (list 안에 dict)
# print(type(holidays))            # <class 'list'>
# print(type(holidays[0]))         # <class 'dict'>

# 2) 공휴일을 하나씩 꺼내 날짜와 한국어 이름 출력하기
print("=== 2026년 대한민국 공휴일 ===")
for number, holiday in enumerate(holidays, 1):   # 1번부터 번호 붙이기
    date = holiday["date"]            # dict에서 날짜 꺼내기
    name = holiday["localName"]       # dict에서 한국어 이름 꺼내기
