...
# 검색 결과가 없으면 data["teams"]가 None이므로 안내 후 종료한다.
if not data.get("teams"):
    print(f"'{team_name}' 팀을 찾지 못했습니다. 영문 팀명을 확인하세요.")
    raise SystemExit

# 2) dict -> list -> dict 순서로 접근해 '팀 dict' 꺼내기
team = data["teams"][0]   # "teams"의 값은 리스트, 그 0번째가 팀 dict
